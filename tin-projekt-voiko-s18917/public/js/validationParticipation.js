import {minPlayerPlace, maxPlayerPlace, maxCoinsWon, minCoinsWon} from "../../model/sequelize/Participation";
...
function validateForm() {
    ...
    const results = [
        ...
        validatePositiveNumber(inputs[1], errors[2],minPlayerPlace, maxPlayerPlace, false),
        validatePositiveNumber(inputs[2], errors[3], minCoinsWon, maxCoinsWon, false)
    ];
    results.forEach(e => {
            if (!e) {
